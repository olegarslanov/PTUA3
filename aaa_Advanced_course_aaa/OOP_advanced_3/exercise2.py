...
# First the program should ask if table was reserved/ not (Providing your full name) . And then
# if not would assign you a table (there is a specific number single, double or family tables) .
