...
class TestRegisterUser(unittest.TestCase):
    ...
    def test_register_user(self, mock_database, mock_input):
        ...
        mock_database.email_check.return_value = User(
        ...
        user = user_repo.register_user(mock_database)
        ...
        assert mock_database.register_user.call_count == 1
        ...
        assert mock_database.register_user.call_args.kwargs == {
            "name": "a",
            "surname": "b",
            "email": "c",
            "password": "d",
        ...
        assert mock_database.email_check.call_count == 1
        ...
        assert mock_database.email_check.call_args.args[0] == "c"
